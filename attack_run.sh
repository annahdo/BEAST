...
python adv_attack_BEAST.py --model_name "TinyLlama/TinyLlama-1.1B-Chat-v1.0" --num_adv_tokens $NUM_ADV_TOKENS --num_data_points $NUM_SAMPLES
python adv_attack_BEAST.py --model_name "lmsys/vicuna-7b-v1.5" --num_adv_tokens $NUM_ADV_TOKENS --num_data_points $NUM_SAMPLES
python adv_attack_BEAST.py --model_name "lmsys/vicuna-13b-v1.5" --num_adv_tokens $NUM_ADV_TOKENS --num_data_points $NUM_SAMPLES --batch_size 3
